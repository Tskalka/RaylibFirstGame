...
namespace C__Projects
{
    ...
    {
        private Raylib_cs.Color _backgroundColor = Raylib_cs.Color.GRAY;
        ...
        /// <summary>
        /// Uses Raylib to init audio device and play music
        /// </summary>
        public void PlayMusic()
        {
            Raylib.InitAudioDevice();
            Music music = Raylib.LoadMusicStream("Loyalty_Freak_Music_-_04_-_Cant_Stop_My_Feet_.mp3");
